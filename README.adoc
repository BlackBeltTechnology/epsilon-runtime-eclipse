...
It is the epsilon runtime project (https://github.com/BlackBeltTechnology/epsilon-runtime) eclipse plugin version.
...
https://github.com/BlackBeltTechnology/epsilon-runtime-eclipse/releases
...
https://app.wercker.com/BlackbeltTechnology/epsilon-runtime-eclipse/runs
